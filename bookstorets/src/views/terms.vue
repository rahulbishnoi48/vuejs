...
Child Sexual Abuse and Exploitation: Do not create, upload, or distribute content that exploits or abuses children. This includes all child sexual abuse materials. To report content on a Google product that may exploit a child, click Report abuse. If you find content elsewhere on the internet, please contact the appropriate agency in your country directly.

More broadly, ../views/About.vue../views/About.vueogle prohibits the use of our products to endanger children. This includes but is not limited to predatory behavior towards children such as:
...
Terrorist Activities: Terrorist organizations are not permitted to use this product for any purpose, including recruitment. We’ll also take action against the user for content related to terrorism, such as promoting terrorist acts, inciting violence, or celebrating terrorist attacks. If storing or distributing content related to terrorism for an educational, documentary, scientific, or artistic purpose be mindful to provide enough information so viewers understand the context.

Unauthorized Images of Minors: Do not store or distribute images of minors without explicit consent from the child's parent, guardian, or legal representative. If someone has stored or distributed an image of a minor without necessary consent, please report it to us.

Violence and Gore: Do not store or distribute violent or gory content involving real- life people or animals that’s primarily intended to be shocking, sensational, or gratuitous. This includes ultra-graphic material, such as dismemberment or close-up footage of mutilated corpses, and graphic material, such as content containing significant amounts of blood. Content may be allowed in an educational, documentary, scientific, or artistic context, but please be mindful to provide enough information to help people understand the context. In some cases, content may be so violent or shocking that no amount of context will allow that content to remain on our platforms. Lastly, don't encourage others to commit specific acts of violence.
